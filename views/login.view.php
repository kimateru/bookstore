...
<body>
    <div class="container h-screen mx-auto px-4 flex flex-col mt-[100px]">
        ...
        <form action="../handlers/userLogin.handler.php" method="post" class="flex flex-col gap-6 mt-8 mb-4">
        ...
        <?php endif; ?>
        <p class='mt-4 text-sm text-[#8E8E93] text-center'>Don’t have an account yet?<a class="font-bold" href="register.view.php"> Sign up here</a></p>
    </div>
</body>
