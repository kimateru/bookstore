...
<body>
    <div class="container mx-auto px-4 py-4">
        ...
        <form action="../handlers/product.handler.php" method="post" class="flex flex-col gap-4 mt-6"
            ...
            <div class=" flex flex-col gap-2 ">
                ...
                <textarea class="border border-[#EB5757] text-[#8E8E93] px-3 py-3 focus:outline-none rounded-md"
                    id="description" name="description" rows="7" value="<?= htmlspecialchars($product['description']) ?>"></textarea>
            </div>
            <div class=" flex flex-col gap-2 ">
